...
<div class="row" id="global-content">
	...
	<form name="mnInsertForm" action="mnInsertProcess" id="mnInsertForm" class="row g-3 border-primary" method="post" enctype="multipart/form-data">
	<!-- <form name="mnUpdateForm" action="mnUpdateProcess" id="mnUpdateForm" class="row g-3 border-primary" method="post"> -->
	  	<!-- 테스트를 위한 임시 회원 번호 -->
		...
		<input type="hidden" class="form-control" name="mnNo" value="${mnotice.mnNo}">
	  	...
	  	<div class="col-4 offset-md-2">
		    ...
		    <input type="text" class="form-control" name="mnWriter"  id="mnWriter" placeholder="작성자를 입력해 주세요" value="로그인유저">
  		</div>
		...
		<div class="col-8 offset-md-2">
  		...
  		<div class="col-8 offset-md-2">
		    ...
		    <input type="radio" name="mnFixTopYn" id="mnFixTopYn_1" value="N" ${!(mnotice.mnFixTopYn eq 'Y') ? 'checked' : '' }> 미고정
		    <input type="radio" name="mnFixTopYn" id="mnFixTopYn_2" value="Y" ${!(mnotice.mnFixTopYn eq 'N') ? 'checked' : '' }> 고정
  		</div>
