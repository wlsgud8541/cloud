...
<div class="row" id="global-content" style="min-height: 600px">
	...
	<div class="row">
		<div class="col text-center">
			<input type="button" class="btn btn-warning" id="mnUpdate" data-mnNo="${mnotice.mnNo}" value="수정하기"/>&nbsp;&nbsp;
			<input type="button" class="btn btn-danger" id="mnDelete" data-mnNo="${mnotice.mnNo}" value="삭제하기" />&nbsp;&nbsp;
			<input type="button" value="목록보기" class="btn btn-primary" onclick="location.href='mnSelectList'"/>
		</div>
	</div>
</div>	