...
<!-- 			<button type="button" style="border:none;background-color:transparent; position:absolute; top: 14px; left: 472px;"><img alt="" src="resources/image/main/mainSearch.png"class="rounded-circle"></button>  -->
		...
		<div class="col-4 row pt-4">
			...
			<div class="col text-end row">
				<div class="col pt-3">
					<span><b>${sessionScope.userId }</b>님<br>로그인하셨습니다.</span>
				</div>
				<div class="col text-center">
					<a href="mmLogout"><img src="resources/image/main/logout.png" style="width:80px;"><br>로그아웃</a>
				</div>
				<div class="col text-start">
