...
<div class="row w3-content" id="global-content">
	<div class="row my-3 text-center">
		<div class="col">
			<h2 class="fs-3 fw-bold">실종자 신고 수정</h2>
			<p class="border border-bottom border-danger border-2" style="width: 200px; display: inline-block; margin-bottom: 0px;"></p>
		</div>
	</div>
	<form name="mhrUpdateProcess" action="mhrUpdateProcess" id="mhrModifyForm" 
	...
	<input type="hidden" name="mhrWriter" value="${sessionScope.userId}">
     ...
     <div class="col-6 row offset-md-1"> 
		...
		<input type="text" class="form-control col rounded-0" name="mhrLocalDetail" id="addr1" readonly value="${mhReport.mhrLocalDetail }">
	...
	<div class="col-4">
	    ...
	    <input class="form-control rounded-0" name="mhrNation " id="mhrNation" value="${mhReport.mhrNation}" readonly ></input>
  	</div>
  	<div class="col-4">
...
<!--   	파일 -->
  	<div class="col-12">
	    <input type="file" class="form-control rounded-0" name="mhrAddFile" id="mnAddFile" value="${mhReport.mhrAddFile}">
  	</div>
