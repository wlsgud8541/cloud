...
public interface MrequestDao {
	// 건의게시판 목록화면 조회
	public List<Mrequest> mrSelectList(int startRow, int pageSize, String typ, String keyword);
	// 건의게시판 게시 글 수 반환
	public int getMrSelectCnt(String type, String keyword);
	// 건의게시판 목록화면 조회
	public List<Mrequest> mrSelectList(int startRow, int pageSize, String typ, String keyword, String mmNo);
	// 건의게시판 게시 글 수 반환
