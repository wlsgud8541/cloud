...
<%String mmUseUserInfoYn = request.getParameter("mmUseUserInfoYn"); %>
   ...
   <div class="root mt-5">
        <form class="signin-wrapper form active" action="mmInsertJoin" method="post" id="insertJoin" name="insertJoin">
            ...
            <h2 class="text-center"><b>Cloud 회원가입</b></h2>
            	<div class=joinForm>
	            	...
	            	<div class="joinGroup">
			            ...
			            <input type="text" class="join-field" id="name"></input>
			            <label for="date" class="joinTitle"><b>생년월일</b></label>
			            <input  type="date" placeholder="" class="join-field" id=""></input>
			            <label  class="joinTitle"><b>성별</b></label>
			            <select class="join-field">
			            	<option>성별</option>
			            	<option>남자</option>
			            	<option>여자</option>
			            </select>
						...
						<span class="row">
							...
							<span class="col-md-3 emailCheck">
								<button type="button" class="secondary" id="emailSendBtn">이메일 인증하기</button>
							</span>
						</span>
	            	</div>
	            	<div class="joinGroup">
			        	<label for="zipcode" class="joinTitle">우편번호</label><br>
						<input type="text" class="mail-field" name="mmZipCode" id="zipcode" maxlength="5" disabled>&nbsp;&nbsp;
						<input type="button" class="btn btn-secondary" id="btnZipcode" value="우편번호 찾기"><br>
						<label for="addr1" class="joinTitle">자택주소</label>
						<input type="text" class="join-field" name="mmAddr1" id="addr1" disabled>
