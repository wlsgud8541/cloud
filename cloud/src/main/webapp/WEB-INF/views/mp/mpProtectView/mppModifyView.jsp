...
<div class="row" id="global-content">
	...
	<div class="col-8 offset-md-2">
		...
		<div class="row mb-2">
			<div class="col-5">
			    <label for="mppPetType" class="form-label border-bottom border-2 border-primary border-opacity-25">동물 종류</label>
		  	...
		  	<div class="col-4">
			     <label for="mppGen" class="form-label border-bottom border-2 border-primary border-opacity-25">동물 성별</label>
		  	...
		  	<div class="col-3">
			    <label for="mppInfoDate" class="form-label border-bottom border-2 border-primary border-opacity-25">실종 날짜</label>
